=== Plugin Name ===
Contributors: nanoplugins
Donate link: http://rotatordemo.nanoplugins.com/
Tags: rotate widgets, widget rotator, widget rotator plugin, wordpress rotator plugin, wordpress widget rotator, wp utility to rotate widgets, wp widget rotator
...
Rotate multiple widgets in a single spot easily using this plugin.
...
To install Wordpress Widget Rotator Pro.

1. Upload widget-rotator-pro folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Go to Appearance -> Widgets and you will find widget rotator pro in there.

== Frequently Asked Questions ==

= Is there any usage restriction for this plugin ? =

It is free for multiple sites on non-commercial websites. However if it is a commercial website please get a license from : http://rotatordemo.nanoplugins.com/. It costs only $5 (multi site license).

= Will this plugin be continuously updated ?=

Yes it will be. We have future plans regarding this plugin.
...
= 1.0 =
* Added the plugin for first time

== Upgrade Notice ==

= 1.0 =
Kept for future reference to notify updates
